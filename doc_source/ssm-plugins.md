...
\(Schema version 2\.0 or later\) Install or uninstall an AWS package\. Available packages include the following: 
...
This plugin runs on Linux and Microsoft Windows Server operating systems\. For more information, see [AWS Systems Manager Documents](sysman-ssm-docs.md)\.
